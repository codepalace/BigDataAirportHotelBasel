...
public class TopPanelTelefonbuch extends JPanel {
	...
	public TopPanelTelefonbuch(JButton btnHome, JButton btnParking, JButton btnFundsachen, JButton btnFitness,
							   JButton btnUerbergabe, JButton btnLogout, 
...
private void init() {
		...
		//We initialize the panel of the buttons
				...
				this.telefonImage = new JLabel(new ImageIcon(getClass().getResource("/img/calling_guy.png")));
				...
				//Initialize the containerSearch Object
						...
						this.add(this.telefonImage, BorderLayout.WEST);
