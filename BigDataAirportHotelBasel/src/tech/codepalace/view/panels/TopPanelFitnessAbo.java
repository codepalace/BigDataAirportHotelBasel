 ...
 * 
 * @description Class that only imports the JPanel to the DataBaseGUI class corresponding to the Fitness Subscription application.
 * 
 * <p>This class has the JPanel with the Menu buttons and the Image corresponding to the Fitness Subscription.</p>
 *
 */

@SuppressWarnings("serial")
public class TopPanelFitnessAbo extends JPanel {
...
private void init() {
		...
		// And add the containerSearchSelect to the containerPanelButton position
		// Center.
		...
		this.searchJComboBox
				.setUI(SelectCustomJComboBox.createUI(this, "down_black_arrow.png", "pink_arrow_right.png"));
		...
		this.add(this.fitnessImage, BorderLayout.WEST);
